<?php $__env->startSection('styles'); ?>
    <link href="<?php echo e(asset('src/assets/css/light/components/list-group.css')); ?>" rel="stylesheet" type="text/css">
    <link href="<?php echo e(asset('src/assets/css/light/users/user-profile.css')); ?>" rel="stylesheet" type="text/css" />

    <link href="<?php echo e(asset('src/assets/css/dark/components/list-group.css')); ?>" rel="stylesheet" type="text/css">
    <link href="<?php echo e(asset('src/assets/css/dark/users/user-profile.css')); ?>" rel="stylesheet" type="text/css" />
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\projects\green-tire\resources\views/profile/showProfile.blade.php ENDPATH**/ ?>