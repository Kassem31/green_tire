<?php $__env->startSection('styles'); ?>
    ...
    <link rel="stylesheet" type="text/css"
        href="<?php echo e(asset('src/plugins/src/table/datatable/extensions/responsive/responsive.dataTables.min.css')); ?>">
    <link rel="stylesheet" type="text/css"
        href="<?php echo e(asset('src/plugins/css/light/table/datatable/responsive.bootstrap5.min.css')); ?>">
    <link rel="stylesheet" type="text/css"
        href="<?php echo e(asset('src/plugins/css/dark/table/datatable/responsive.bootstrap5.min.css')); ?>">
...
<?php $component = App\View\Components\AddButton::resolve(['model' => 'repair-steps','name' => 'repair step'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
                ...
                <div class="col-xl-12 col-lg-12 col-sm-12  layout-spacing">
                    <div class="widget-content widget-content-area br-8">
                        <form method="GET" action="<?php echo e(route('repair-steps.index')); ?>" class="mb-3">
                            <div class="row align-items-end">
                                <div class="col-md-4 col-12 filter-column">
                                    <input type="text" id="name" name="name" class="form-control"
                                        placeholder="Filter by Name" value="<?php echo e(request('name')); ?>">
                                </div>
...
<?php endif; ?>
                        ...
                        <div class="table-responsive">
                            <table id="zero-config" class="table dt-table-hover" style="width:100%">
                                ...
                                <tbody>
                                    <?php $__currentLoopData = $repairSteps; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $repairStep): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            <td data-th="ID"><?php echo e($repairStep->id); ?></td>
                                            <td data-th="Name (Arabic)"><?php echo e($repairStep->name_ar); ?></td>
                                            <td data-th="Name (English)"><?php echo e($repairStep->name_en); ?></td>
                                            <td data-th="Created At"><?php echo e($repairStep->created_at->format('Y-m-d')); ?></td>
...
<?php $component = App\View\Components\ShowButton::resolve(['route' => 'repair-steps.show','param' => $repairStep->id,'name' => 'repair step'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $component = App\View\Components\EditButton::resolve(['route' => 'repair-steps.edit','param' => $repairStep->id,'name' => 'repair step'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $component = App\View\Components\DeleteButton::resolve(['route' => 'repair-steps.destroy','param' => $repairStep->id,'name' => 'repair step'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $__env->startSection('scripts'); ?>
    ...
    <script src="<?php echo e(asset('src/plugins/src/table/datatable/extensions/responsive/dataTables.responsive.min.js')); ?>">
    </script>
    <script>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\projects\green-tire\resources\views/repair-steps/index.blade.php ENDPATH**/ ?>