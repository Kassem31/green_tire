        ...
        <div class="row layout-top-spacing">
            ...
            <div class="col-xl-12 col-lg-12 col-sm-12 layout-spacing">
                <div class="widget-content widget-content-area br-8">
                    ...
                    <form method="POST" action="<?php echo e(route('repair-transactions.store')); ?>" id="repair-form">
                        <?php echo csrf_field(); ?>
                        ...
                        <div class="form-group mb-4">
                            ...
                            <input type="hidden" name="inspection_transaction_id" value="<?php echo e($inspectionTransaction->id); ?>">
                        </div>
                        ...
                        <div class="form-group mb-4">
                            <a href="<?php echo e(route('inspection-transactions.index')); ?>" class="btn btn-secondary"><?php echo e(__('Back to List')); ?></a>
                            <button type="submit" class="btn btn-primary"><?php echo e(__('Save Repair Transaction')); ?></button>
                        </div>
                    </form>
                </div>
            </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\Projects\green-tire\resources\views/repair-transactions/create.blade.php ENDPATH**/ ?>