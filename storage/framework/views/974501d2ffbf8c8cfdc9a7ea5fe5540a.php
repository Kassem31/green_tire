                ...
                <div class="col-xl-12 col-lg-12 col-sm-12  layout-spacing">
                    <div class="widget-content widget-content-area br-8">
                        <form method="GET" action="<?php echo e(route('repair-steps.index')); ?>" class="mb-3">
                            <div class="row">
                                <div class="col-md-4" style="margin-left: 1rem; margin-top: 1rem;">
                        ...
                        <table id="zero-config" class="table dt-table-hover" style="width:100%">
                            ...
                            <tbody>
                                <?php $__currentLoopData = $repairSteps; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $repairStep): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        <td><?php echo e($repairStep->id); ?></td>
                                        <td><?php echo e($repairStep->name_ar); ?></td>
                                        <td><?php echo e($repairStep->name_en); ?></td>
                                        <td><?php echo e($repairStep->created_at->format('Y-m-d')); ?></td>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\Projects\green-tire\resources\views/repair-steps/index.blade.php ENDPATH**/ ?>