...
<?php $component = App\View\Components\AddButton::resolve(['model' => 'observations','name' => 'observation'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
                ...
                <div class="col-xl-12 col-lg-12 col-sm-12  layout-spacing">
                    <div class="widget-content widget-content-area br-8">
                        <form method="GET" action="<?php echo e(route('observations.index')); ?>" class="mb-3">
                            <div class="row align-items-end">
                                
                                <div class="col-md-3 mb-3">
                                    <label for="filter-name-ar" class="form-label">Arabic Name</label>
                                    <input type="text" id="filter-name-ar" name="name_ar" class="form-control"
                                        placeholder="Filter by Arabic Name" value="<?php echo e(request('name_ar')); ?>">
                                </div>
                                <div class="col-md-3 mb-3">
                                    <label for="filter-name-en" class="form-label">English Name</label>
                                    <input type="text" id="filter-name-en" name="name_en" class="form-control"
                                        placeholder="Filter by English Name" value="<?php echo e(request('name_en')); ?>">
                                </div>
                                <div class="col-md-3 mb-3">
                            ...
                            <tbody>
                                <?php $__currentLoopData = $observations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $observation): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        ...
                                        <td><?php echo e($observation->name_ar); ?></td>
                                        <td><?php echo e($observation->name_en); ?></td>
...
<?php $component = App\View\Components\ShowButton::resolve(['route' => 'observations.show','param' => $observation->id,'name' => 'observation'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $component = App\View\Components\EditButton::resolve(['route' => 'observations.edit','param' => $observation->id,'name' => 'observation'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $component = App\View\Components\DeleteButton::resolve(['route' => 'observations.destroy','param' => $observation->id,'name' => 'observation'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
            ...
            button.addEventListener('click', function() {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        // Create and submit the form to delete the observation
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\Projects\green-tire\resources\views/observations/index.blade.php ENDPATH**/ ?>