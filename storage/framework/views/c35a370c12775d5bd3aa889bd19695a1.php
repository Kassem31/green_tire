    ...
    <div class="middle-content container-xxl p-0">
        ...
        <div class="page-meta">
            <nav class="breadcrumb-style-one" aria-label="breadcrumb">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="#">Inspection Transactions</a></li>
                </ol>
            </nav>
        </div>
        <!-- /BREADCRUMB -->
                    ...
                    <table id="zero-config" class="table dt-table-hover" style="width:100%">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><?php echo e($transaction->decision); ?></td>
                                <td><?php echo e($transaction->building_date ? $transaction->building_date->format('Y-m-d') :
                                    'N/A'); ?></td>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\Projects\green-tire\resources\views/inspection-transactions/index.blade.php ENDPATH**/ ?>